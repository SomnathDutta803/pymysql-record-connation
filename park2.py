...
try:
    ...
    if result: 
        print("\n  A record with same id no already exists!...CANNOT INSERT ROW !\n") 
    else: 
        cursor.execute("INSERT INTO Emp_details VALUES(%s, %s, %s, %s, %s, %s, %s);",(id, name, department, salary, gender, age, city)) 
        mycon.commit() 
